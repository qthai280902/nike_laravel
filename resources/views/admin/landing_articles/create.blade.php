...
@section('page_title', 'Thêm bài viết Trang chủ')
...
<div class="mb-6 flex items-center space-x-3 text-xs uppercase tracking-wider">
    ...
    <span class="text-white">Thêm bài viết</span>
</div>

<div class="mb-6">
    <h3 class="text-lg font-bold text-white uppercase tracking-wider">Tạo bài viết mới</h3>
</div>

<div class="type-card rounded-xl p-6 mb-8">
    <form action="{{ route('admin.landing-articles.store') }}" method="POST" class="space-y-6">
        @csrf
        
        @include('admin.landing_articles._form')
